...
ActiveRecord::Schema.define(version: 20150511172711) do
  ...
  add_index "passenger_bookings", ["booking_id", "passenger_id"], name: "index_passenger_bookings_on_booking_id_and_passenger_id"
